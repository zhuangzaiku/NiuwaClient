...
//    ListView menuList;
    ...
    private void initView() {
        long getTokenTime = (long) SharePrefsUtils.get(CommunityActivity.this, "user", "getTokenTime", 0L);
        if (System.currentTimeMillis() - getTokenTime >= TWO_DAYS) {
            SharePrefsUtils.remove(CommunityActivity.this, "user", "token");
        }
...
//        });
        ...
        enterLiving.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CommunityActivity.this, LivingActivity.class);
    ...
    private void initData() {
        if (!StringUtils.isEmpty(token) && !StringUtils.isEmpty(userId)) {
            ...
            Api.getUserInfo(CommunityActivity.this, requestParams, new OnRequestDataListener() {
                @Override
                public void requestSuccess(int code, JSONObject data) {
                    if (isActive) {
                        JSONObject userInfo = data.getJSONObject("data");
                        String nickname = userInfo.getString("user_nicename");
                        SharePrefsUtils.put(CommunityActivity.this, "user", "user_nicename", nickname);
                        SharePrefsUtils.put(CommunityActivity.this, "user", "user_level", userInfo.getString("user_level"));
                        SharePrefsUtils.put(CommunityActivity.this, "user", "avatar", userInfo.getString("avatar"));
                        MyApplication app = (MyApplication) CommunityActivity.this.getApplication();
                        ...
                        Glide.with(CommunityActivity.this).load(userInfo.getString("avatar"))
                                .error(R.drawable.icon_avatar_default)
                                .transform(new GlideCircleTransform(CommunityActivity.this))
                                .into(userHead);
